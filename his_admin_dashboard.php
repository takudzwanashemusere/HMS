                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Luisa Guidotti Information Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="user-box">
                    ...
                    <h5><a href="javascript: void(0);">Natasha Mugoni</a> </h5>
                ...
                <div class="p-3">
                    <div class="inbox-widget">
                        <div class="inbox-item">
                            ...
                            <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Tanaka</a></p>
                            <p class="inbox-item-text">I've finished it! See you so...</p>
                        </div>
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="assets/images/users/user-3.jpg" class="rounded-circle" alt=""></div>
                            <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Takudzwa</a></p>
                            <p class="inbox-item-text">This theme is awesome!</p>
                        </div>
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="assets/images/users/user-4.jpg" class="rounded-circle" alt=""></div>
                            <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Tatenda</a></p>
                            <p class="inbox-item-text">Nice to meet you</p>
                        </div>

                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="assets/images/users/user-5.jpg" class="rounded-circle" alt=""></div>
                            <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Chido</a></p>
                            <p class="inbox-item-text">Hey! there I'm available...</p>
                        </div>
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="assets/images/users/user-6.jpg" class="rounded-circle" alt=""></div>
                            <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Mariele</a></p>
                            <p class="inbox-item-text">This theme is awesome!</p>
                        </div>
